...
<html lang="en">
  ...
  <link href="https://fonts.googleapis.com/css2?family=Ruwudu&display=swap"
      rel="stylesheet"/>
</head>
...
<body>
    ...
    <div class="login-box">
      ...
      <form action="" id="contactForm">
        ...
        <div class="user-box">
          <button type="submit" name="sumbit">Submit <span></span>
            <span></span>
            <span></span>
            <span></span>
          </button>
...
<?php
    ...
    $query= "INSERT INTO PEOPLE VALUES('$un','$em','$pwd','$conpwd')";
